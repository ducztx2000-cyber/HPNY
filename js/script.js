...
const WISH_MESSAGES = [
	...
	"Chúc năm mới vạn sự như ý, tấn tài tấn lộc 🌸",
    "Chúc bạn một năm tràn đầy sức khỏe và thành công rực rỡ 🌟",
    "Chúc mọi dự định trong năm đều suôn sẻ và thuận buồm xuôi gió ⛵",
    "Chúc gia đình luôn sum vầy, ấm áp và yêu thương nhau mãi mãi 💕",
    "Chúc bạn đón năm mới với thật nhiều niềm vui và tiếng cười 😄",
    "Chúc con đường phía trước luôn rộng mở và đầy cơ hội mới 🌈",
    "Chúc bạn luôn tự tin, bản lĩnh và đạt được điều mình mong muốn 🎯",
    "Chúc một năm mới bứt phá mạnh mẽ và thành công ngoài mong đợi 🚀",
    "Chúc bạn luôn bình an trong tâm hồn và hạnh phúc trong trái tim 💖",
    "Chúc năm mới ngập tràn tài lộc, may mắn và điều tốt đẹp nhất 🍀",
];
